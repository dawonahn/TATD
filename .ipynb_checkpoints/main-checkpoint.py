...
def tatd_parser():
    ...
    parser.add_argument('--name', type=str, default='indoor_1', help=u"Dataset")
    parser.add_argument('--sparse', type=int, default=1, help=u"Sparsity penalty")
    ...
    parser.add_argument('--opt_scheme', type=str, default='als_adam', help=u"Alternating Adam")
    ...
    parser.add_argument('--count', type=int, default=100, help=u"Experiment for average")
